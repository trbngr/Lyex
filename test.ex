[def(ndf_dgen(%WeatherService.NDFDgenInput{} = input)) do
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "NDFDgenResponse", WeatherService.NDFDgenOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "NDFDgenLatLonListResponse", WeatherService.NDFDgenLatLonListOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "LatLonListSubgridResponse", WeatherService.LatLonListSubgridOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "LatLonListLineResponse", WeatherService.LatLonListLineOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "LatLonListZipCodeResponse", WeatherService.LatLonListZipCodeOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "LatLonListCityNamesResponse", WeatherService.LatLonListCityNamesOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "LatLonListSquareResponse", WeatherService.LatLonListSquareOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "CornerPointsResponse", WeatherService.CornerPointsOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "GmlLatLonListResponse", WeatherService.GmlLatLonListOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "GmlTimeSeriesResponse", WeatherService.GmlTimeSeriesOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "NDFDgenByDayResponse", WeatherService.NDFDgenByDayOutput)
  end
  ...
  with({:ok, %{body: body}} <- HTTPoison.post(address, envelope, headers)) do
    read(body, "NDFDgenByDayLatLonListResponse", WeatherService.NDFDgenByDayLatLonListOutput)
  end
end]